...
export const CHECKLIST_FIELDS = [
  ...
  { id: "protectionGalvaGereePar", label: "Protection Galva gérée par" },
  { id: "protectionThermoGereePar", label: "Protection Thermolaquage gérée par" },
  { id: "livraisonSiteProtection", label: "Livraison site de protection" },
  { id: "livraisonSiteGalva", label: "Livraison site de Galva" },
  { id: "livraisonSiteThermo", label: "Livraison site de Thermolaquage" },
  { id: "paiementFacturesGalva", label: "Paiement de la facture Galva" },
  { id: "paiementFacturesThermo", label: "Paiement de la facture Thermolaquage" },
  { id: "enlevementSiteProtection", label: "Enlèvement site de protection" },
  { id: "enlevementSiteGalva", label: "Enlèvement site de Galva" },
  { id: "enlevementSiteThermo", label: "Enlèvement site de Thermolaquage" },
